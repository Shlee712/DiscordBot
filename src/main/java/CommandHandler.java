...
public class CommandHandler {
    ...
    static {
        ...
        commandMap.put("react", (event, args) -> {
        	BotUtils.reactMessage(event.getMessage());
        });
        
        commandMap.put("counter", (event, args) -> {
        	BotUtils.sendMessage(event.getChannel(), "Please react to this message within the next 5 seconds.");
        });
    ...
    public void onMessageReceived(MessageReceivedEvent event){
        ...
        List<String> argsList = new ArrayList<String>(Arrays.asList(argArray));
